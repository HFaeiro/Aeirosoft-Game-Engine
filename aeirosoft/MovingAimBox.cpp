...
MovingAimBox::MovingAimBox(graphics* g) : g(g), Ai(g, L"Data\\Objects\\Bully\\Bully.fbx") { srand(static_cast <unsigned> (time(0))); }
...
DirectX::XMVECTOR LoadFloat3(float a, float b, float c)
{
	DirectX::XMFLOAT3&& f3 = DirectX::XMFLOAT3(a, b, c);
...
void MovingAimBox::UpdateMove()
{
	...
	float moveSpeed = m_moveSpeed * elap;
	...
	{
	case 0:
		toVector = LoadFloat3(moveSpeed, 0, 0);
	...
	//	toVector = DirectX::XMLoadFloat3(&DirectX::XMFLOAT3(-moveSpeed, 0, 0));
		...
		break;
	case 2:
		toVector = LoadFloat3(0, moveSpeed, 0);
	...
	//	toVector = DirectX::XMLoadFloat3(&DirectX::XMFLOAT3(0, -moveSpeed, 0));
		...
		break;
	case 4:
		toVector = LoadFloat3(0, 0, moveSpeed);
	...
	case 5:
		...
		break;
	case 6:
		toVector = LoadFloat3(moveSpeed, 0, moveSpeed);
	...
	case 7:
		...
		break;
	case 8:
		toVector = LoadFloat3(moveSpeed, moveSpeed, 0);
	...
	case 9:
		...
		break;
	case 10:
		toVector = LoadFloat3(0, moveSpeed, moveSpeed);
